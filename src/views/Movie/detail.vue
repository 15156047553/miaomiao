...
<div id="detailContrainer" class="slide-enter-active">
  ...
  <div v-else id="content" class="contentDetail">
    <div class="detail_list">
      <div class="detail_list_bg" :style="{'background-image': `url(${detailMovie.img.replace(/w\.h/, '216.300')})`}"></div>
...
export default {
  ...
  mounted () {
    this.axios({
      url: `/api/detailmovie?movieId=${this.movieId}`
    }).then((res) => {
      if (res.data.msg === 'ok') {
